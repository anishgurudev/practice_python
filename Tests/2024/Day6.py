...
for employee in employees:
    ...
    print(f'{employee[0]} worked for {employee[1]} at {employee[2]} per hour. So total due amount is {total_pay}')
...
for employee in employees:
    if employee[2]>average_wage:
        print(f"{employee[0]} is earning above average wage({average_wage})")
